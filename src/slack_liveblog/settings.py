"""
Django settings for slack_liveblog project.
...
SLACKCHAT_PUBLISH_ROOT = os.getenv('SLACKCHAT_PUBLISH_ROOT')
...
ROOT_URLCONF = 'slack_liveblog.urls'
...
WSGI_APPLICATION = 'slack_liveblog.wsgi.application'
